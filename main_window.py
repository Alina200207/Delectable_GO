...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.lbl.move(int(self.width_desk*0.1), int(self.height_desk*0.3))
        ...
        self.lbl.setFont(QFont("Times", int(self.width_desk*0.03), QFont.Bold))
        self.button_enter.setFont(QFont("Times", int(self.width_desk * 0.015)))
        self.lbl.setAlignment(Qt.AlignVCenter)
        self.qle.setStyleSheet("background-color: white;")
        self.qle.setFont(QFont("Times", int(self.width_desk * 0.015), QFont.Bold))
        self.lbl.adjustSize()
